...
// Dispalys Account objects in a vector of Account objects
...
void deposit(std::vector<Account> &accounts, double amount){
  std::cout << "\n=== Depositiong to Accounts ====================" << std::endl;
...
// Withdraw amount from each Account object in the std::vector
...
// Helper fuctions for Savings Account class

// Displays Savings Account objects
...
// Deposited supplied amount to each Savings Account object in the vector
...
void deposit(std::vector<Checking_Account> &accounts, double amount){
  std::cout << "\n=== Depositing to Checking Accouts=================" << std::endl;
  for(auto &acc:accounts){
    if(acc.deposit(amount)){
      std::cout << "Deposited " << amount << " to " << acc << std::endl;
    }else{
...
// Withdraw supplied amount from each Cheking Account object in the vector
